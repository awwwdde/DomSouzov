    ...
    if settings.SEED_DEMO_CONTENT and db.query(Hall).count() == 0:
        halls = [
            Hall(
                ...
                scheme="/uploads/scheme-kolonnyy.jpg",
                equipment_ru="\n".join([
                    "Цифровой микшер Soundcraft Vi6",
                    "Линейный массив CODA AUDIO 300 Вт (24 шт)",
                    "Сабвуферы CODA AUDIO 1200 Вт (6 шт)",
                    "Сценические мониторы CODA AUDIO 500 Вт (4 шт)",
                    "4 микрофона Shure",
                    "Рояль Steinway & Sons (сцена)",
                    "Рояль Bechstein (2 шт)",
                    "Рояль «Москва»",
                ]),
                equipment_en="",
                rider_only=False,
            ...
            Hall(
                ...
                scheme="/uploads/scheme-oktyabrskiy.jpg",
                equipment_ru="\n".join([
                    "Цифровой микшер Yamaha TF-1",
                    "Порталы и сабвуферы JBL",
                    "4 радиомикрофона",
                ]),
                equipment_en="",
                rider_only=False,
            ...
            Hall(
                name_ru="Зал №1", name_en="Hall №1",
                capacity="до 100 мест", area="",
                columns=None,
                features_ru="[]", features_en="",
                description_ru="Универсальное пространство для деловых мероприятий: заседания, переговоры, пресс-конференции, подписания соглашений, совещания и «круглые столы» без изменения интерьерных решений.",
                description_en="A versatile space for business events: meetings, negotiations, press conferences, signings, and round tables without altering the interior.",
                scheme="/uploads/scheme-zal1.jpg",
                equipment_ru="\n".join([
                    "Цифровой микшер Allen & Heath SQ-6",
                    "Конференц-система (30 микрофонов)",
                ]),
                equipment_en="",
                rider_only=False,
                sort_order=3,
            ...
            Hall(
                name_ru="Буфет Колонного зала", name_en="Hall of Columns Buffet",
                capacity="до 300 человек", area="",
                columns=None,
                features_ru="[]", features_en="",
                description_ru="Предназначен для организации выставок, буфетного, фуршетного или банкетного обслуживания. Не мебелирован.",
                description_en="Intended for exhibitions, buffet, banquet or catering service. Unfurnished.",
                scheme=None, equipment_ru="", equipment_en="",
                rider_only=True,
                sort_order=4,
            ),
            Hall(
                name_ru="Анфилада", name_en="Enfilade",
                capacity="до 500 человек", area="",
                columns=None,
                features_ru="[]", features_en="",
                description_ru="Предназначена для проведения выставок, фуршетов, мастер-классов. Возможность воспроизведения фоновой музыки, размещение баннеров, стендов и фуршетных столов. Мебелирована.",
                description_en="Intended for exhibitions, receptions and master classes. Background music playback, banners, stands and buffet tables. Furnished.",
                scheme=None, equipment_ru="", equipment_en="",
                rider_only=True,
                sort_order=5,
            ),
