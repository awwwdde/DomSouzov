    ...
    sections: [
      ...
      },
      {
        ...
        fields: [
          ...
          { key: 'footer_udp_caption', label: 'Подпись под логотипом', type: 'text', hint: 'Показывается под логотипом по центру и одновременно служит описанием картинки (alt). Например: «Управление делами Президента Российской Федерации».' },
