...
const SECTIONS: RuleSection[] = [
  ...
  },
  {
    ...
    items: [
      { n: '2.1', text: 'Запрещается проходить в здание с оружием, огнеопасными, взрывчатыми, ядовитыми, пахучими и радиоактивными веществами, колющими и режущими предметами, пиротехническими устройствами, лазерными фонариками, наркотическими веществами, алкогольными напитками, пищей, чемоданами, крупными свёртками и сумками, в пачкающей одежде или с предметами, которые могут испачкать других посетителей, мебель и иное имущество, расположенное в здании Дома Союзов.' },
      { n: '2.2', text: 'С целью обеспечения безопасности контроль посетителей и находящихся при них вещей осуществляется как визуально, так и с применением металлодетекторов и иных специальных приборов и устройств.' },
      { n: '2.3', text: 'В случае отказа пройти досмотр, посетитель не допускается в здание.' },
      { n: '2.4', text: 'После прохождения посетителем досмотра осуществляется проверка основания прохода на мероприятие, выставку, экскурсию (билет, приглашение, список, заявка).' },
      { n: '2.5', text: 'Вход в здание Дома Союзов с животными запрещён, за исключением случаев посещения мероприятий, выставок, экскурсий лицами с ограниченными возможностями, для которых животное является поводырём и необходимым условием передвижения.' },
      { n: '2.6', text: 'Посетители возраста до 14 лет допускаются в здание Дома Союзов только в сопровождении совершеннолетних сопровождающих.' },
      { n: '2.7', text: 'При посещении мероприятий, выставок, экскурсий группой посетителей несовершеннолетнего возраста обязательно присутствие сопровождающего лица старше 18 лет, из расчёта не менее одного сопровождающего на 10 несовершеннолетних посетителей. Руководитель группы или сопровождающие родители принимают на себя ответственность за жизнь и здоровье, а также за поведение сопровождаемых детей на протяжении всего пребывания в здании Дома Союзов.' },
      { n: '2.8', text: 'Учреждение не несёт ответственность за задержку при проходе в здание Дома Союзов в связи с осуществлением досмотра сотрудниками охраны.' },
    ],
  },
  {
    ...
    items: [
      ...
      { n: '3.7', text: 'В случае обнаружения оставленных без присмотра предметов или вещей необходимо немедленно сообщить об этом сотрудникам охраны / частного охранного предприятия / представителям администрации. Брать в руки, открывать, сдвигать с места данные предметы строго запрещается.' },
